    ...
    <div className="page-content">
      <div className="page-heading">
        <div>
          ...
          <p>
            Overview of the security mechanisms implemented in the Secure
            Medical Data system.
          </p>
        </div>

        <span className="secure-badge">SYSTEM STATUS: PROTECTED</span>
      </div>

      <div className="security-summary">
        <div className="security-summary-icon">S</div>

        <div>
          <h3>Multi-Layer Data Protection</h3>

          <p>
            The application combines authentication, password protection,
            encryption and text steganography to protect sensitive medical data.
          </p>
        </div>
      ...
      <div className="security-grid">
        {securityModules.map((module) => (
          <section className="security-card" key={module.title}>
            <div className="security-card-top">
              <div className="security-module-icon">{module.icon}</div>

              <span className="security-active">✓ {module.status}</span>
            </div>

            <h3>{module.title}</h3>

            <p className="security-description">{module.description}</p>

            <div className="security-details">
              {module.details.map((detail) => (
                <div className="security-detail" key={detail}>
                  <span>✓</span>
                  <span>{detail}</span>
                </div>
              ))}
      ...
      <div className="security-workflow">
        <div className="security-workflow-heading">
          <div>
            <p className="section-label">PROTECTION WORKFLOW</p>

            <h3>Medical Data Security Flow</h3>
          </div>
        </div>
        ...
        <div className="security-flow">
          <div className="flow-item">
            ...
            <small>Sensitive information</small>
          </div>
          ...
          <div className="flow-item">
            ...
            <small>Payload concealment</small>
          </div>
      ...
      <div className="security-note">
        ...
        <p>
          <strong>Implementation note:</strong> Text steganography is
          implemented using zero-width Unicode characters. This is a technical
          implementation decision for this project; the original project concept
          requires text steganography but does not prescribe this specific
          technique.
        </p>
      </div>
    </div>
